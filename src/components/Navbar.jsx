    ...
    <>
        ...
        <div className="max-w-6xl mx-auto px-6 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            ...
            <button
              ...
              className="flex items-center space-x-1 px-3 py-1.5 text-xs font-mono font-semibold rounded-full border border-zinc-200 dark:border-zinc-800 text-zinc-800 dark:text-zinc-200 hover:bg-zinc-200/60 dark:hover:bg-zinc-800/60 transition-colors"
            ...
            <button
              onClick={toggleTheme}
              className="p-2 rounded-full border border-zinc-200 dark:border-zinc-800 text-zinc-800 dark:text-zinc-200 hover:bg-zinc-200/60 dark:hover:bg-zinc-800/60 transition-colors"
            ...
            {/* Unified Toggle Menu Button (For Both Desktop & Mobile) */}
            <button
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-50 bg-zinc-950/95 dark:bg-zinc-950/98 backdrop-blur-xl text-zinc-50 flex flex-col justify-between p-6 sm:p-12 animate-in fade-in duration-300">
          ...
          {/* Numbered Navigation Links List */}
