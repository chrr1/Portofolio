...
export const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col justify-between pt-20 pb-6 px-6 sm:px-12 overflow-hidden bg-zinc-50 text-zinc-950 dark:bg-zinc-950 dark:text-zinc-50 transition-colors duration-300">
      ...
      {/* Center Giant Layered Typography Background (Enlarged for Mobile) */}
      <div className="absolute top-[38%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-full text-center pointer-events-none select-none z-0">
        <h1 className="text-[17vw] sm:text-[14vw] md:text-[12vw] lg:text-[12rem] font-extrabold tracking-tighter uppercase leading-[0.82] text-zinc-800/90 dark:text-zinc-200/90 transition-colors">
          SOFTWARE<br />ENGINEER
        </h1>
      </div>

      {/* Center Hero Plain Image with Smooth Fade Gradient Mask */}
      <div className="relative z-10 flex-1 flex items-end justify-center pt-4 pb-0 my-auto pointer-events-none">
        <div className="relative w-full max-w-lg h-[54vh] sm:h-[62vh] lg:h-[68vh] flex justify-center items-end">

          {/* Plain Profile Image with Smooth Bottom Gradient Fade */}
          <img
      ...
      {/* Bottom Hero Information Grid (Left & Right) */}
      <div className="relative z-20 grid grid-cols-1 md:grid-cols-12 gap-6 items-end pb-6 pt-2">

        {/* Bottom Left: MY NAME & Stacked Name */}
        <div className="md:col-span-6 space-y-1.5">
          <span className="text-[11px] font-mono text-zinc-500 dark:text-zinc-400 uppercase tracking-widest block font-medium">
            MY NAME
          </span>
        ...
        {/* Bottom Right: ABOUT ME & Short Paragraph */}
      ...
      <div className="relative z-20 pt-4 pb-6 border-t border-zinc-200 dark:border-zinc-800 flex items-center justify-between text-[11px] font-mono text-zinc-400 dark:text-zinc-500">
        <a
          href="#about"
          className="flex items-center space-x-2 uppercase tracking-widest hover:text-zinc-950 dark:hover:text-zinc-50 transition-colors"
        >
          <span>SCROLL</span>
